  ...
  function (BaseController, Device, View) {
    ...
    return BaseController.extend('sap.ui.demo.chartdemo.controller.Master', {
      onChartTypeChanged: function () {
        ...
        par =
          'chartType=' +
          this.byId('select').getSelectedKey() +
          '&' +
          'color=' +
          this.byId('selectColor').getSelectedKey() +
          '&' +
          'tooltip=' +
          this.byId('selectPopover').getSelectedKey() +
          '&' +
          'measureNames=' +
          measure
      ...
      onRouteMatched: function (oEvent) {
        ...
        if (hasValidURL) {
          ...
          this.byId('Lucro').setSelected(false)
          this.byId('Custo').setSelected(false)
          this.byId('Receita').setSelected(false)
